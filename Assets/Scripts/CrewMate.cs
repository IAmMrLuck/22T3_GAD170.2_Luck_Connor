        ...
        {
            {
                ...
                crewName = names[Random.Range( 0,12 )];

                if(Random.Range( 1, 5) == 4)
                {
                    parasite = true;
                    hobby = falseHobbies[Random.Range( 0,4 )];
                }

                else
                {
                    hobby = trueHobbies[Random.Range(0, 12)];
                }
                /*
                                int randomNumber;
                                int lastNumber;
                                ...
                                if (parasite)
                                {
                                    ...
                                    {
                                        FullName newCrew = Instantiate(CrewMates, transform);
